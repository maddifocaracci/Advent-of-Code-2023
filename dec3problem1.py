...
# Make a list to save indices of symbols
symbol_indices = []
...
for i in range(df.shape[0]):
    ...
    for char in row:
        ...
        # If we come across a symbol, save its location in the df
        if char != '.' and not char.isdigit():
            symbol_indices.append((i, char_idx))
        char_idx += 1
...
# Now, I want to check for numbers around each symbol index.
